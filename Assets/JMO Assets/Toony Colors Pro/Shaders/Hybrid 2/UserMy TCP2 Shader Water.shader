...
Shader "Toony Colors Pro 2/User/My TCP2 Shader Water"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
...
/* TCP_DATA u config(ver:"2.9.16";unity:"6000.0.32f1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2","ENABLE_DEPTH_NORMALS_PASS","ENABLE_FORWARD_PLUS","VERTEX_SIN_WAVES","RAMP_BANDS","RAMP_MAIN_OTHER","RAMP_SEPARATED","VSW_2","RIM","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting"];shaderProperties:list[,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,sp(name:"Foam Color";imps:list[imp_mp_color(def:RGBA(0.9, 0.9, 0.9, 1);hdr:False;cc:4;chan:"RGBA";prop:"_FoamColorRGBOpacityA";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"9e045ad1-bf89-4f6a-8716-e8d6194192e5";op:Multiply;lbl:"Foam Color (RGB) Opacity (A)";gpu_inst:False;dots_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),sp(name:"Foam Texture Custom";imps:list[imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"black";locked_uv:False;uv:0;cc:3;chan:"RGB";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_FoamTextureCustom";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"cd56b857-24c3-474a-87f7-36d97f74b412";op:Multiply;lbl:"Foam Texture Custom";gpu_inst:False;dots_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH f1f140cffce9d041d939b2b1cf83e2a9 */
